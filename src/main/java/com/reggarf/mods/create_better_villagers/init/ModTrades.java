	...
	public static void registerTrades(VillagerTradesEvent event) {
		...
		if (ModConfigs.ENABLE_COPPERWORKER.get()) {
			if (event.getType() == ModVillagers.COPPERWORKER.get()) {
				...
				event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 22), new ItemStack(AllBlocks.COPPER_CASING, 2), new ItemStack(AllBlocks.HOSE_PULLEY, 1), 10, 5, 0.05f));
				...
				event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(AllItems.ELECTRON_TUBE, 2), new ItemStack(AllBlocks.SMART_FLUID_PIPE, 2), 10, 5, 0.05f));
				event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 18), new ItemStack(Blocks.DRIED_KELP_BLOCK, 2), new ItemStack(AllBlocks.SPOUT, 2), 10, 5, 0.05f));
		...
		if (ModConfigs.ENABLE_BRASSWORKER.get()){
			if (event.getType() == ModVillagers.BRASSWORKER.get()) {
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(AllItems.BRASS_INGOT, 5), new ItemStack(AllBlocks.FLYWHEEL, 1), 5, 5, 0.07f));
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 13), new ItemStack(AllItems.ELECTRON_TUBE, 2), new ItemStack(AllBlocks.SEQUENCED_GEARSHIFT, 3), 3, 5, 0.07f));
				event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 12), new ItemStack(AllBlocks.GEARBOX, 2), new ItemStack(AllBlocks.MECHANICAL_CRAFTER, 1), 4, 5, 0.05f));
				event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 21), new ItemStack(AllItems.PRECISION_MECHANISM, 1), new ItemStack(AllBlocks.ROTATION_SPEED_CONTROLLER, 2), 2, 5, 0.05f));
				...
				event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Blocks.EMERALD_BLOCK, 10), new ItemStack(AllItems.ELECTRON_TUBE, 2), new ItemStack(AllBlocks.THRESHOLD_SWITCH, 1), 3, 5, 0.05f));
				event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 19), new ItemStack(AllItems.ELECTRON_TUBE, 2), new ItemStack(AllBlocks.SMART_FLUID_PIPE, 2), 10, 5, 0.05f));
				event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 14), new ItemStack(AllItems.BRASS_SHEET, 5), new ItemStack(AllItems.BRASS_HAND, 2), 4, 5, 0.05f));
		...
		if (ModConfigs.ENABLE_ANDESITE_WORKER.get()){
			if (event.getType() == ModVillagers.ANDESITE_WORKER.get()) {
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 11), new ItemStack(AllBlocks.COGWHEEL, 6), new ItemStack(AllBlocks.GEARBOX, 2), 3, 5, 0.07f));
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 11), new ItemStack(AllBlocks.SHAFT, 6), new ItemStack(AllBlocks.COGWHEEL, 3), 3, 5, 0.07f));
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 16), new ItemStack(AllBlocks.COGWHEEL, 6), new ItemStack(AllBlocks.GEARBOX, 2), 3, 5, 0.07f));
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 10), new ItemStack(AllBlocks.COGWHEEL, 3), new ItemStack(AllBlocks.LARGE_COGWHEEL, 2), 3, 5, 0.07f));
				event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 18), new ItemStack(AllItems.ANDESITE_ALLOY, 3), new ItemStack(AllBlocks.SHAFT, 16), 3, 5, 0.07f));
				event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 14), new ItemStack(AllBlocks.ANDESITE_ALLOY_BLOCK, 1), new ItemStack(AllBlocks.ANDESITE_FUNNEL, 5), 4, 5, 0.05f));
				event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 18), new ItemStack(AllItems.ANDESITE_ALLOY, 3), new ItemStack(AllBlocks.ANDESITE_TUNNEL, 2), 2, 5, 0.05f));
				event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 19), new ItemStack(AllBlocks.SHAFT, 2), new ItemStack(AllBlocks.COGWHEEL, 4), 2, 5, 0.05f));
				...
				event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 15), new ItemStack(AllItems.ROSE_QUARTZ, 3), 3, 5, 0.05f));
				...
				event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 14), new ItemStack(AllItems.GOLDEN_SHEET, 4), new ItemStack(AllItems.GOGGLES, 1), 2, 5, 0.05f));
				event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 18), new ItemStack(AllItems.IRON_SHEET, 8), new ItemStack(AllItems.PROPELLER, 2), 3, 5, 0.05f));
				event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 17), new ItemStack(AllItems.ANDESITE_ALLOY, 10), new ItemStack(AllItems.WHISK, 2), 2, 5, 0.05f));
