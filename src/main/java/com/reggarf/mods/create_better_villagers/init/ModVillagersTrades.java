...
public class ModVillagersTrades {
    ...
    public static void registerTrades(VillagerTradesEvent event) {
        ...
        if (event.getType() == ModVillagerProfessions.ANDESITE_WORKER.get()) {
            ...
            event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 31), new ItemStack(AllItems.ANDESITE_ALLOY.get(), 3), new ItemStack(AllBlocks.SHAFT, 16), 3, 5, 0.07f));
            //LEVEL 2
            ...
            event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 53), new ItemStack(AllItems.ANDESITE_ALLOY.get(), 3), new ItemStack(AllBlocks.ANDESITE_TUNNEL, 2), 2, 5, 0.05f));
            ...
            //LEVEL 3
            event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 20), new ItemStack(Items.IRON_INGOT, 4), new ItemStack(AllItems.IRON_SHEET.get(), 5), 2, 5, 0.07f));
            event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 56), new ItemStack(AllItems.ROSE_QUARTZ.get(), 3), 3, 5, 0.05f));
            //LEVEL 4
            ...
            event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Items.EMERALD, 40), new ItemStack(AllItems.GOLDEN_SHEET.get(),4),new ItemStack(AllItems.GOGGLES.get(), 1), 2, 5, 0.05f));
            //LEVEL 5
            event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 20), new ItemStack(AllItems.IRON_SHEET.get(), 8), new ItemStack(AllItems.PROPELLER.get(), 2), 3, 5, 0.05f));
            event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 39), new ItemStack(AllItems.ANDESITE_ALLOY.get(), 10), new ItemStack(AllItems.WHISK.get(), 2), 2, 5, 0.05f));
        ...
        if (event.getType() == ModVillagerProfessions.BRASS_WORKER.get()) {
            //LEVEL 1

            event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 41), new ItemStack(AllItems.BRASS_INGOT.get(), 5), new ItemStack(AllBlocks.FLYWHEEL, 1), 5, 5, 0.07f));
            event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 39), new ItemStack(AllItems.ELECTRON_TUBE.get(), 2), new ItemStack(AllBlocks.SEQUENCED_GEARSHIFT, 3), 3, 5, 0.07f));
            //LEVEL 2
            ...
            event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 53), new ItemStack(AllItems.PRECISION_MECHANISM.get(), 1), new ItemStack(AllBlocks.ROTATION_SPEED_CONTROLLER, 2), 2, 5, 0.05f));
            //LEVEL 3
            ...
            event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Blocks.EMERALD_BLOCK, 20), new ItemStack(AllItems.ELECTRON_TUBE.get(),2),new ItemStack(AllBlocks.THRESHOLD_SWITCH, 1), 3, 5, 0.05f));
            //LEVEL 5
            event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 64), new ItemStack(AllItems.ELECTRON_TUBE.get(), 2), new ItemStack(AllBlocks.SMART_FLUID_PIPE, 2), 10, 5, 0.05f));
            event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 34), new ItemStack(AllItems.BRASS_SHEET.get(), 5), new ItemStack(AllItems.BRASS_HAND.get(), 2), 4, 5, 0.05f));
        ...
        if (event.getType() == ModVillagerProfessions.COPPER_WORKER.get()) {
            //LEVEL 1

            event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 21), new ItemStack(Items.COPPER_INGOT, 1), new ItemStack(AllItems.COPPER_SHEET.get(), 1), 5, 5, 0.07f));
            event.getTrades().get(1).add(new BasicItemListing(new ItemStack(Items.EMERALD, 11), new ItemStack(AllItems.COPPER_SHEET.get(), 2), new ItemStack(AllBlocks.FLUID_PIPE, 2), 3, 5, 0.07f));
            ...
            //LEVEL 3
            event.getTrades().get(3).add(new BasicItemListing(new ItemStack(Items.EMERALD, 41), new ItemStack(AllItems.COPPER_NUGGET.get(), 31), new ItemStack(AllBlocks.FLUID_TANK, 2), 5, 5, 0.07f));
            ...
            event.getTrades().get(4).add(new BasicItemListing(new ItemStack(Blocks.EMERALD_BLOCK, 20), new ItemStack(AllItems.GOLDEN_SHEET.get(),10),new ItemStack(AllBlocks.STEAM_ENGINE, 1), 10, 5, 0.05f));
        ...
        if (event.getType() == ModVillagerProfessions.MINER.get()) {
            ...
            //LEVEL 2
            event.getTrades().get(2).add(new BasicItemListing(new ItemStack(Items.EMERALD, 30), new ItemStack(Items.IRON_INGOT, 10), new ItemStack(AllItems.ZINC_INGOT.get(), 11), 10, 5, 0.05f));
            ...
            //LEVEL 5
            event.getTrades().get(5).add(new BasicItemListing(new ItemStack(Items.EMERALD, 20), new ItemStack(AllItems.RAW_ZINC.get(), 5), new ItemStack(AllItems.ZINC_INGOT.get(), 7), 4, 5, 0.05f));
